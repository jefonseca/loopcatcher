...
declare -gA MSG_es=(
    ...
    [err.invalid_filename_scheme]='filename_scheme no válido: %s (normal, strict, stream)'
...
%s'
    ...
    [config.paths.filename_scheme.normal]='Colección de Música'
    [config.paths.filename_scheme.strict]='Colección de Música con nombres saneados'
    [config.paths.filename_scheme.stream]='Colección de Streaming'
