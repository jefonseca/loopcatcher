...
declare -gA MSG_en=(
    ...
    [err.invalid_filename_scheme]='Invalid filename_scheme: %s (normal, strict, stream)'
    ...
    [welcome.config_heading]='Current configuration'
...
%s'
    ...
    [config.paths.filename_scheme.normal]='Music Collection'
    [config.paths.filename_scheme.strict]='Music Collection with sanitized names'
    [config.paths.filename_scheme.stream]='Stream Collection'
